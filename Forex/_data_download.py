...
while True:
    ...
    try:
        ...
        while counter1 > 0:
            ...
            print(klines.tail(5))
            if os.name == 'nt':
                klines.to_csv((r'D:\\OHLC\\' + string + '.csv'))  # if using windows change directory
            else:
                klines.to_csv((
                                          r'/home/q/Dropbox/Dracula Blood Money Algo/H1OHLC/' + string + '.csv'))  #if using linux/mac change directory
